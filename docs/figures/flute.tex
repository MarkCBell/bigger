...
\begin{tikzpicture}[scale=2, thick]
    ...
    \draw [red] (1.5, 0.5) to [out=0,in=0] node [right] {a\_0} (1.5, -0.5);
    \draw [red] (2.5, 0.5) to [out=0,in=0] node [right] {a\_1} (2.5, -0.5);
    \draw [red] (3.5, 0.5) to [out=0,in=0] node [right] {a\_2} (3.5, -0.5);
    
    \foreach \i in {1, 2} {
        \draw plot [blue, smooth cycle] coordinates {(\i-0.15+1, 0.25) (\i+1, 0.4) (\i+2, 0.4) (\i+2.15, 0.25) (\i+2, 0.1) (\i+1, 0.1)};
        \node [blue] at (\i+1.5, 0.25) {b\_\i};
    }
